const cacheName="CACHE_V1"; // Name of the cache
const appFiles=[            // List of files to be cached
  "/",
  "/index.html",
	"/manifest.json",
	"/js/scripts.js",
...
self.addEventListener("install",(installing)=>{   // Install event of the service worker
